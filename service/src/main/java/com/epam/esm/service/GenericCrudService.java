...
public interface GenericCrudService<T extends BaseAbstractDomain, ID extends Serializable, C extends Criteria> {
     ...
     */
    Long delete(ID id) throws ObjectNotFoundException, ActionFallDaoException, ActionFallDaoException;
     ...
     * @return List of required object
     */
    List<T> doFilter(C criteria) throws ObjectNotFoundDaoException, ObjectNotFoundDaoException;
