...
public class GiftCertificateDaoImpl implements GiftCertificateDao {
    ...
    @Autowired
    public GiftCertificateDaoImpl(EntityManager entityManager, GiftCertificateRowMapper giftCertificateRowMapper, QueryCreator queryCreator, GiftCertificateResultSetExtractor extractor, TagDao tagDao) {
